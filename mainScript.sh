...
checkFiles(){ # Este metodo serve para verificar se todos os ficheiros necessarios existem.
...
echo   mcmcp ngen=1000000 printfreq=1000 samplefreq=100 diagnfreq=1000 nchains=4 savebrlens=yes filename=mitoTree";" >> ~/Desktop/sequencesVMPY/nexSeqs/mitoConc.nex
...
echo   mcmcp ngen=1000000 printfreq=1000 samplefreq=100 diagnfreq=1000 nchains=4 savebrlens=yes filename=nucTree";" >> ~/Desktop/sequencesVMPY/nexSeqs/nucConc.nex
...
echo   mcmcp ngen=1000000 printfreq=1000 samplefreq=100 diagnfreq=1000 nchains=4 savebrlens=yes filename=totalTree";" >> ~/Desktop/sequencesVMPY/nexSeqs/totalConc.nex
